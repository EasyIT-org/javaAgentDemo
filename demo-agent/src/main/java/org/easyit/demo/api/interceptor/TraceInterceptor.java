...
public class TraceInterceptor extends AbstractInterceptor {
    ...
    public TraceInterceptor(CutPoint cutPoint, ArrayList<Endpoint> tracerAdaptors) {
        super(cutPoint, tracerAdaptors);
    }

    @Override
    protected void doBeforeMethod(Endpoint tracerAdaptor, Parameters parameters, Context context) {
    ...
    @Override
    protected void doAfterMethod(Endpoint tracerAdaptor, ReturnParameters returnParameters, Context context) {
    ...
    @Override
    protected void doHandleMethodException(Endpoint tracerAdaptor, ExceptionParameters exceptionParameters, Context context) {
